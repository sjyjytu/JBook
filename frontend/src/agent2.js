...
//
// const requests = {
//     get: (url)=>superagent.get(RootUrl+url).set('Content-Type','application/json').then(()=>superagent.get('/cookied-page')).then(resBody),
...
//     delete:(url,body)=>superagent.delete(RootUrl+url).set('Content-Type','application/json').send(body).then(resBody),
//     put:(url,body)=>superagent.put(RootUrl+url).set('Content-Type','application/json').send(body).then(resBody)
// };
//
