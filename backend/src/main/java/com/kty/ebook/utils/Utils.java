...
//            props.put("mail.smtp.port", "465" );
            ...
            msg.setSubject("激活邮件");
            msg.setContent("<h1>此邮件为官方激活邮件！请点击下面链接完成激活操作！</h1><h3><a href='http://localhost:8080/api/user/activate?code="+code+"'>http://localhost:8080/api/user/activate</a></h3>","text/html;charset=UTF-8");
            msg.saveChanges();
